...
function Chat() {
  ...
  //πρόσθεσε το useRef για να δημιουργήσεις μια αναφορά στο input.
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setUserInput(''); // Καθαρισμός του input
  
      // Διασφάλιση ότι το input παίρνει ξανά το focus
       setTimeout(() => {
         inputRef.current?.focus(); // Επιστρέφει τον κέρσορα στο input
      }, 0); // Χρησιμοποιούμε το setTimeout για να επιτρέψουμε την ανανέωση του state πριν το focus
      ...
      // Επαναφορά του focus στο input πεδίο
    ...
    <div className="chat">
      ...
      <div className="chatbox">
        ...
        <div className="input-container">
          <input
            ref={inputRef} // Προσθήκη της αναφοράς
            type="text"
            value={userInput}
            onChange={(e) => setUserInput(e.target.value)}
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                sendMessage(); // Καλεί τη συνάρτηση sendMessage() όταν πατηθεί το Enter
              }
            }}
